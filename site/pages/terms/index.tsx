...
export default function NotFound() {
  ...
  return (
    <div className="max-w-2xl mx-8 sm:mx-auto py-20 flex flex-col fit">
      <Text variant="heading">Terms of use</Text>
      ...
      Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE
      ...
      apply. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in
      any revised Terms of Use by your continued use of the Site after the date such revised Terms of Use are posted.
      <br/><br/>
      ...
      <Text variant='sectionHeading'>2. INTELLECTUAL PROPERTY RIGHTS</Text>
      ...
      <Text variant='sectionHeading'>3. USER REPRESENTATIONS</Text>

      By using the Site, you represent and warrant that: 12) you will maintain the accuracy of such information and
      promptly update such registration information as necessary (3 4) you are not a minor in the jurisdiction in which
      you reside; (567) your use of the Site will not violate any applicable law or regulation.
      <br/><br/>
      ...
      <Text variant='sectionHeading'>4. USER REGISTRATION</Text>
      ...
      <Text variant='sectionHeading'>5. PROHIBITED ACTIVITIES</Text>
      ...
      <br/><br/>Systematically retrieve data or other content from the Site to create or compile, directly or
      indirectly, a collection, compilation, database, or directory without written permission from us.
      <br/><br/>Trick, defraud, or mislead us and other users, especially in any attempt to learn sensitive account
      information such as user passwords.
      <br/><br/>Circumvent, disable, or otherwise interfere with security-related features of the Site, including
      features that prevent or restrict the use or copying of any Content or enforce limitations on the use of the Site
      and/or the Content contained therein.
      <br/><br/>Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site.
      <br/><br/>Use any information obtained from the Site in order to harass, abuse, or harm another person.
      ...
      <br/><br/>Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material,
      ...
      <br/><br/>Engage in any automated use of the system, such as using scripts to send comments or messages, or using
      ...
      <br/><br/>Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or active
      ...
      <br/><br/>Interfere with, disrupt, or create an undue burden on the Site or the networks or services connected to
      the Site.
      <br/><br/>Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion
      of the Site to you.
      <br/><br/>Attempt to bypass any measures of the Site designed to prevent or restrict access to the Site, or any
      portion of the Site.
      <br/><br/>Copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other
      code.
      <br/><br/>Except as permitted by applicable law, decipher, decompile, disassemble, or reverse engineer any of the
      software comprising or in any way making up a part of the Site.
      <br/><br/>Except as may be the result of standard search engine or Internet browser usage, use, launch, develop,
      ...
      <br/><br/>Make any unauthorized use of the Site, including collecting usernames and/or email addresses of users by
      electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated
      means or under false pretenses.
      <br/><br/>Use the Site as part of any effort to compete with us or otherwise use the Site and/or the Content for
      any revenue-generating endeavor or commercial enterprise.
      <br/><br/>

      <Text variant='sectionHeading'>6. USER GENERATED CONTRIBUTIONS</Text>
      ...
      <br/><br/>The creation, distribution, transmission, public display, or performance, and the accessing,
      downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including but
      not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.
      <br/><br/>You are the creator and owner of or have the necessary licenses, rights, consents, releases, and
      ...
      <br/><br/>You have the written consent, release, and/or permission of each and every identifiable individual
      person in your Contributions to use the name or likeness of each and every such identifiable individual person to
      enable inclusion and use of your Contributions in any manner contemplated by the Site and these Terms of Use.
      <br/><br/>Your Contributions are not false, inaccurate, or misleading.
      <br/><br/>Your Contributions are not unsolicited or unauthorized advertising, promotional materials, pyramid
      schemes, chain letters, spam, mass mailings, or other forms of solicitation.
      <br/><br/>Your Contributions are not obscene, lewd, lascivious, filthy, violent, harassing, libelous, slanderous,
      or otherwise objectionable (as determined by us).
      <br/><br/>Your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.
      <br/><br/>Your Contributions are not used to harass or threaten (in the legal sense of those terms) any other
      person and to promote violence against a specific person or class of people.
      <br/><br/>Your Contributions do not violate any applicable law, regulation, or rule.
      <br/><br/>Your Contributions do not violate the privacy or publicity rights of any third party.
      <br/><br/>Your Contributions do not violate any applicable law concerning child pornography, or otherwise intended
      to protect the health or well-being of minors.
      <br/><br/>Your Contributions do not include any offensive comments that are connected to race, national origin,
      gender, sexual preference, or physical handicap.
      <br/><br/>Your Contributions do not otherwise violate, or link to material that violates, any provision of these
      Terms of Use, or any applicable law or regulation.
      <br/><br/>Any use of the Site in violation of the foregoing violates these Terms of Use and may result in, among
      other things, termination or suspension of your rights to use the Site.


      <Text variant='sectionHeading'>7. CONTRIBUTION LICENSE</Text>
      ...
      <Text variant='sectionHeading'>8. SUBMISSIONS</Text>
      ...
      <Text variant='sectionHeading'>9. SITE MANAGEMENT</Text>
      ...
      <br/><br/>
      <Text variant='sectionHeading'>10. PRIVACY POLICY</Text>

      By using the Site, you agree to be bound by our Privacy Policy posted on the Site, which is incorporated into
      these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any
      ...
      <Text variant='sectionHeading'>11. TERM AND TERMINATION</Text>
      ...
      <Text variant='sectionHeading'>12. MODIFICATIONS AND INTERRUPTIONS</Text>
      ...
      <Text variant='sectionHeading'>13. GOVERNING LAW</Text>

      These Terms shall be governed by and defined following the laws of . SoCloud Technology, Inc. and
      yourself irrevocably consent that the courts of shall have exclusive jurisdiction to resolve any
      dispute which may arise in connection with these terms.
      <br/><br/>

      <Text variant='sectionHeading'>14. DISPUTE RESOLUTION</Text>
      ...
      <Text variant='sectionHeading'>15. CORRECTIONS</Text>
      ...
      <Text variant='sectionHeading'>16. DISCLAIMER</Text>
      ...
      <Text variant='sectionHeading'>17. LIMITATIONS OF LIABILITY</Text>
      ...
      <Text variant='sectionHeading'>18. INDEMNIFICATION</Text>
      ...
      <Text variant='sectionHeading'>19. USER DATA</Text>
      ...
      <Text variant='sectionHeading'>20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</Text>
      ...
      <Text variant='sectionHeading'>21. CALIFORNIA USERS AND RESIDENTS</Text>
      ...
      <Text variant='sectionHeading'>22. MISCELLANEOUS</Text>
      ...
      <Text variant='sectionHeading'>23. CONTACT US</Text>
